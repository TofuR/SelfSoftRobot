...
> 🔁 **2026-07-20 定位更新**：最终场景无法每步获得真实形态，论文与部署主线已转为 [15 稀疏观测窗口 OpenLoop](15_open_loop_windowed_transition.md)。本方向保留为同一状态转移骨干的 GT-state 诊断：隔离局部单步误差与开环累计误差。下文“实际部署/当前主线”的描述属于早期决策记录。
